...
export class Tab3Page {
  ...
  getBarChart(contexto: any, dados: any){
  ...
  geraHisto(){
    this.analiserService.outra(this.mensagem).subscribe(lista => {
      ...
      this.barChart = this.getBarChart(this.barCanvas, this.listaR);
      this.barChart1 = this.getBarChart(this.barCanvas1, this.listaG);
      this.barChart2 = this.getBarChart(this.barCanvas2, this.listaB);
    }, error =>{
      this.resposta = error;
    });
  }
